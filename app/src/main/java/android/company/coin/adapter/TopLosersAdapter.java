...
import android.company.coin.Data.Model.TopLosers.CryptoCurrencyList;
...
public class TopLosersAdapter extends RecyclerView.Adapter<TopLosersViewHolder> {
    List<CryptoCurrencyList> dataList;
    Context context;
    public static int pos=10;

    public TopLosersAdapter(List<CryptoCurrencyList> dataList, Context context) {
    ...
    @NonNull
    @Override
    public TopLosersViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.item_coin,parent,false);
        return new TopLosersViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull TopLosersViewHolder holder, int position) {
...
class TopLosersViewHolder extends RecyclerView.ViewHolder{
    TextView coinNumber,coinName,coinSymbol,coinPrice,coinChangPrice;
    ImageView coinIcon,coinDiagram;
    ProgressBar progressBar;
    public TopLosersViewHolder(@NonNull View itemView) {
        super(itemView);
